		...
		var html = 
			"<div id='login-content-wrapper' class=''>" +
				...
				"<fieldset class='pw'>  " +
					...
					"</p>" +*/
					"<p>" +
						"<span class='vicciorange'>To provide access to this exclusive merchandise and process your order we need your preferred contact email:</span>" +
					"</p>" +
					...
					"<div id='signin-button-container'>" +
						"<button id='guest-login-button' class='page-button up' type='button'>Submit</button>" +
					"</div>" +
					/*"<div id='styled-password-input'>" +
